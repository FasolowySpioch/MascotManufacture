    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        return http.csrf().disable()
                .authorizeHttpRequests(request-> request
                        .requestMatchers(HttpMethod.POST, "/webapi/mascot").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/webapi/companies").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/webapi/companies/**").authenticated()
